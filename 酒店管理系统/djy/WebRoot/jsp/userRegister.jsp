...
.bg1{
	background-image: url(/rzy_qiaochuang/image/login_head.gif); /*login_submit.gif*/
 }
.span1{
	color:red;
}
.bt1{
	background-image: url(/rzy_qiaochuang/image/btn_reg3.gif);
	width:156px;
	height:35px;
	...
	<div class="container-fluid">
		...
		<tr >
			<td align="center" valign="middle">
			    <form id="form" action="/rzy_qiaochuang/ResUser" method="post">
